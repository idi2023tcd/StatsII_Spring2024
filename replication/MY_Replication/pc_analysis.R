...
#Loading data
pc <- read.csv("C:/NewGithubFolder/StatsII_Spring2024/replication/MY_Replication/pettycorruption_data.csv")
head(pc)
...
# Recode variables
pc$married <- ifelse(pc$married == 0, "Single", "Married")
pc$christ <- ifelse(pc$christ == 0, "Non Christian", "Christian")
pc$region <- ifelse(pc$region == 1, "Greater Accra", ifelse(pc$region == 2, "Central Ghana", "Eastern Ghana"))
