...
#
#Load Data
bolivia <- read.csv("C:/NewGithubFolder/StatsII_Spring2024/Temporary_Replication_Idi/Data APSR/Data/bol_census_elections.csv")
head(bolivia)
dim(bolivia) # Rows/Observations=335; Columns/Variables=6
names(bolivia) #"X", "Departamento" ; "Provincia" ; "Municipio" ; "PobRuralProp2001" ; "mas_per2002"  
str(bolivia)
####
table(bolivia$Departamento)
# Answer:
...
# SHAPEFILE DATA
###
shape_muni <- read_sf("C:/NewGithubFolder/StatsII_Spring2024/Temporary_Replication_Idi/Data APSR/Data/bol_admbnda_adm3_gov_2020514.shp")
head(shape_muni)
##
shape_dep <- read_sf("C:/NewGithubFolder/StatsII_Spring2024/Temporary_Replication_Idi/Data APSR/Data/bol_admbnda_adm1_gov_2020514.shp")
head(shape_dep)
##
